...
<!--    <div>印花税：成交金额的1‰ 。2008年9月19日由向双边征收改为向出让方单边征收</div>-->
<!--    <div>证管费：成交金额的0.002%双向收取</div>-->
<!--    <div>3.证券交易经手费：A股，按成交金额的0.00487%双向收取；B股，按成交额0.00487%双向收取；基金，上海证券交易所按成交额双边收取0.0045%，深圳证券交易所按成交额0.00487%双向收取；权证，按成交额0.0045%双向收取。-->
...
<!--      另外，部分地方还收委托费。这笔费用主要用于支付通讯等方面的开支,一般按笔计算（由证券公司营业部决定收不收，证券公司多的地方，相互竞争，大多取消这项，比如大城市，证券公司少的地方，营业部可能收你成交一笔收一元或五元，比如小城镇）</div>-->
